...
parser.add_argument('--modelRoot', default='train', help='the path to store the testing results')
parser.add_argument('--epochId', type=int, default=98, help='the number of epochs being trained')
